...
//         <div className="flex-1 overflow-y-auto p-4 text-white border-t border-neutral-800">
//           {searchTerm ? (
//             filteredResults.length > 0 ? (
//               filteredResults.map((result) => (
//                 <div
...
//        <DialogContent className="sm:max-w-[600px] h-[80vh] md:h-[400px] max-h-[90vh] overflow-y-auto">
//         <DialogHeader>
//           <DialogTitle className="text-white">Create Group</DialogTitle>
//           <DialogDescription>
//             This action helps to create a group.
...
//           {searchTerm && (
//             <ScrollArea className="h-auto w-full rounded-md border p-4 text-white">
