...
import { Compass, Heart, Home, Image, Instagram, Menu, Search, X } from 'lucide-react';
                                ...
                                <>
                                    {/* <Button variant="ghost" onClick={link.onClick} className="flex items-center gap-2">
                                        ...
                                        <Sheet open={isSearchOpen} onOpenChange={setIsSearchOpen}>
                                            ...
                                            <SheetContent
                                                side="right"
                                                className="w-[300px] p-4 bg-white dark:bg-neutral-950 dark:text-white border-l-[.2px] border-zinc-800 rounded-tl-3xl rounded-bl-3xl transition-transform duration-300"
                                            >
...
//                         {/* <Instagram /> */}
//                         <IoEarthSharp className="text-purple-500 w-8 h-8" />
//                         {!compact && <span className='hidden lg:inline'>SocialSphere</span>}
//                     </h1>
//                 </Link>
