...
const ReelSection = () => {
    ...
    return (
        <>
        {/* <div className="flex-1 min-h-screen flex flex-col items-center py-4  dark:bg-neutral-950 dark:text-white"> */}
                                        ...
                                        >
                                            ...
                                            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black to-transparent">
                                                ...
                                                >
                                                    ...
                                                    <Button variant="outline" className="ml-2 px-4 py-1 text-xs text-white bg-transparent border">
                                                        Follow
                                                    </Button>
                                                </motion.div>

                                                <motion.p className="text-white text-sm mb-2" variants={fadeUp} initial="hidden" animate="visible" transition={{ delay: 0.5 }}>
                                                    {post.caption}
                                                </motion.p>

                                                <motion.div className="flex items-center text-white" variants={fadeUp} initial="hidden" animate="visible" transition={{ delay: 0.6 }}>
